...
// Unfilled track — the light gridline/hairline neutral, not a step of any
// status hue, since the fill's color itself changes with severity (there's
// no single ramp to stay "on" the way a single-hue meter would).
