...
import { BUDGET_TRACK_COLOR, getBudgetStatus } from "../utils/budgetStatus.js";
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundColor: BUDGET_TRACK_COLOR }}
      >
        <div
      ...
      <div className="mt-1.5 flex items-center gap-1.5 text-sm">
        ...
        {remaining < 0 ? (
          <span className="text-gray-500">— excedido em {formatCurrency(-remaining)}</span>
        ) : (
          <span className="text-gray-500">— restam {formatCurrency(remaining)}</span>
        )}
      </div>
    </div>
  );
